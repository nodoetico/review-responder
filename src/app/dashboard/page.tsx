    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          ...
          <p className="text-3xl font-bold text-gray-900">{resumen?.locales ?? 0}</p>
          <p className="text-gray-500 text-sm">Locales registrados</p>
          <Link href="/dashboard/locales" className="text-primary-600 text-sm hover:underline mt-2 block">
            Administrar →
          </Link>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          ...
          <p className="text-3xl font-bold text-gray-900">{resumen?.resenas_pendientes ?? 0}</p>
          <p className="text-gray-500 text-sm">Respuestas pendientes</p>
          <Link href="/dashboard/resenas" className="text-primary-600 text-sm hover:underline mt-2 block">
            Revisar →
          </Link>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border">
          ...
          <p className="text-3xl font-bold text-gray-900">{resumen?.rating_promedio?.toFixed(1) ?? "—"}</p>
      ...
      {(!resumen || resumen.locales === 0) && (
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-8 text-center">
          <h2 className="text-lg font-semibold text-blue-800 mb-2">Todavía no agregaste ningún local</h2>
          <p className="text-blue-600 mb-4">Agregá tu primer negocio para empezar a recibir reseñas.</p>
          <Link
